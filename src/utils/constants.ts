export const commitGeneratePrompt = (summary: string) => {
  ...
  2. 2. **Support for Multiple Scopes**: If the commit affects multiple scopes, the scopes should be reflected accordingly and separated by a space after the comma. For example:
