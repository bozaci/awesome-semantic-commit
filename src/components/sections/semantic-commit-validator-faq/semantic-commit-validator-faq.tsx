...
const SemanticCommitValidatorFAQ = () => {
  const t = useTranslations('semanticCommitValidatorFAQ');
  const FAQData = [
    {
  ...
  return (
    <section className="semantic-commit-validator-faq">
...
export default SemanticCommitValidatorFAQ;
